...
const defaultFeatures: ProductFeature[] = [
  ...
  },
  {
    ...
    description: '03 Active Integrations',
    icon: null,
    gridSpan: { desktop: { col: 2 } },
    ...
    data: {
      integrations: [
        ...
        {
          icon: <Calendar className="w-4 h-4 text-purple-600 dark:text-purple-400" aria-hidden="true" />,
          color: 'purple',
          bgColor: 'bg-purple-100 dark:bg-purple-900/20',
        },
        {
          icon: <Lightbulb className="w-4 h-4 text-yellow-600 dark:text-yellow-400" aria-hidden="true" />,
          color: 'yellow',
          bgColor: 'bg-yellow-100 dark:bg-yellow-900/20',
        },
      ],
      integrationsCount: '03 Active Integrations',
    },
  },
  {
    id: 'range-ratio',
  ...
  },
  {
    ...
    data: {
      percentage: '42%',
      percentageSubtitle: 'Monthly Focus',
      percentageLabel: 'Maximum of focus',
    },
  },
  {
    id: 'productivity',
  ...
  return (
    ...
    >
      <PageContainer>
        ...
        >
          {/* Banner Card - Spans 4 columns to match width of three cards below */}
          <div
            className="lg:col-span-4 bg-card border border-border rounded-xl transition-all duration-300 hover:shadow-md hover:border-primary/20"
            style={{
              padding: '0',
              borderRadius: 'var(--radii-card-default)',
              borderColor: 'var(--color-button-secondary-border)',
